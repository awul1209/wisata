<div class="card card-info mt-3" id="card-data">
    <div class="card-header" style="background-color: #004072;">
        <h5 class="card-title" style="color: #fff;">
            <i class="fa fa-table"></i> Data Rating
        </h5>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        ...
        <div class="table-responsive">
            ...
            <table id="example" class="table table-bordered table-striped" style="font-size: 14px;">
                ...
                <tbody>
                    ...
                    <?php
                    $no = 1;
                    $result = mysqli_query($koneksi, "SELECT user.nama,rating.id,rating1,komentar,rating.created_at,rating.updated_at FROM rating JOIN user ON rating.user_id = user.id");
